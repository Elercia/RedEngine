...
VirtualPoolAllocator::VirtualPoolAllocator(VirtualPoolAllocator&& other)
{
    *this = std::move(other);
}

VirtualPoolAllocator& VirtualPoolAllocator::operator=(VirtualPoolAllocator&& other)
{
    m_blockSize = other.m_blockSize;
    m_capacity = std::exchange(other.m_capacity, 0);
    m_currentAllocationCount = std::exchange(other.m_currentAllocationCount, 0);
    m_pageAlloc = std::exchange(other.m_pageAlloc, {nullptr, 0});
    m_nextFreeBlock = std::exchange(other.m_nextFreeBlock, nullptr);
