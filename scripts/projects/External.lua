...
externalDirectoryPath= rootPath .. "externals"
...
if os.istarget("windows") then
	...
	filter { "system:windows" }
		postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/SDL2/lib/x64/SDL2.dll %{cfg.buildtarget.directory}" }	
	filter {}
end
...
filter { "platforms:Win64" }
	postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/Fmod/core/lib/x64/fmod.dll %{cfg.buildtarget.directory}" }
	postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/Fmod/fsbank/lib/x64/fsbank.dll %{cfg.buildtarget.directory}" }
	postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/Fmod/fsbank/lib/x64/libfsbvorbis64.dll %{cfg.buildtarget.directory}" }
	postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/Fmod/fsbank/lib/x64/opus.dll %{cfg.buildtarget.directory}" }
	postbuildcommands { "{COPYFILE} " .. externalDirectoryPath .. "/Fmod/studio/lib/x64/fmodstudio.dll %{cfg.buildtarget.directory}" }
filter {}
